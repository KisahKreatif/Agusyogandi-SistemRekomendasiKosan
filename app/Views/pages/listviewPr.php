<?php 
  ...
  $builder = $db->query("SELECT * FROM data_alternatif WHERE jenis_indekos = 'perempuan'||'Perempuan'  ORDER BY nilai_rangking1 ASC");
...
<!-- lgoo pilihan filter -->
<center>
<img src="/img/h1.png" class="imglist" ></center>
</br>
<p class="text1"> INDEKOS Perempuan</p>
<hr class="hr"/>
